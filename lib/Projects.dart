    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          buildermob(img: 'image/flutter1.png',name: 'BMI BMR and Ideal Weight Calculator', desc: 'Flutter',url: 'https://play.google.com/store/apps/details?id=co.dartartau.bmicalculator',),
          buildermob(img: 'image/flutter1.png',name: 'Covid 19 Advisory by WHO', desc: 'Flutter Web',url: 'https://tscorona-535f0.firebaseapp.com',),
          ...
          InkWell(
              ...
              onTap: () => launch('https://github.com/hirdan')),
        ],
      ),
    );
  }
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                builder(img: 'image/flutter.jpg',name: 'BMI BMR and Ideal Weight Calculator', desc: 'Flutter',a: 0.20, b: 0.015, c: 0.015,url: 'https://play.google.com/store/apps/details?id=co.dartartau.bmicalculator'),
                SizedBox(width: 5,),
                builder(img: 'image/flutter.jpg',name: 'Covid 19 Advisory by WHO', desc: 'Flutter Web',a: 0.20, b: 0.015, c: 0.015,url: 'https://tscorona-535f0.firebaseapp.com',),
                SizedBox(width: 5,),
